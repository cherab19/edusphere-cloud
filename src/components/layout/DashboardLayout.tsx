    ...
    <div className="min-h-screen flex bg-background">
      ...
      >
        ...
        <div className="h-16 flex items-center px-4 border-b border-sidebar-border">
          ...
          {!collapsed && (
            <span className="ml-3 font-display font-bold text-lg text-sidebar-primary-foreground">
              EduERP
            </span>
          )}
        </div>
      ...
      <div className={cn("flex-1 flex flex-col transition-all duration-300", collapsed ? "lg:ml-[68px]" : "lg:ml-64")}>
        ...
        <header className="h-16 bg-card border-b border-border flex items-center justify-between px-6 sticky top-0 z-30">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="font-display font-semibold text-sm">Addis Ababa Academy</h2>
